...
- [x] Zustand 설치 및 인증 스토어 생성
- [x] 커스텀 탭 네비게이션 컴포넌트 구현
  - [x] Pan Gesture 기반 좌우 스와이프
  - [x] 탭 전환 애니메이션
  - [x] 탭 인디케이터
- [x] 인증 가드 구현
  - [x] 인증 상태 체크
...
- ✅ 버그 수정: 가운데 아이콘에서만 제스처 시작되도록 수정
  - `GestureDetector` 위치 조정
  - `pointerEvents` 설정으로 터치 이벤트 통과 구현
