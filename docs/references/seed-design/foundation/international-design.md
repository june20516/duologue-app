...
fetched: 2026-08-31T04:58:58.002Z
-->
...
SEED는 전 세계에서 똑같이 유용하고 가치있는 경험을 제공할 수 있도록 돕습니다.

![International Design cover image](/og/foundations/international-design.webp)

## [Overview](#overview)

국제화는 단순한 언어 번역을 넘어서는 작업입니다. 어떤 언어로 번역하더라도 톤, 용어, 표현이 일관되게 전달되어 브랜드 아이덴티티와 사용자 경험이 유지되어야 합니다. 나아가 각 지역의 문화와 언어에 자연스럽게 녹아들어, 사용자가 서비스를 신뢰하고 적극적으로 활용할 수 있어야 합니다. 이 가이드는 다양한 언어와 문화에 대응하는 디자인 지침을 제공합니다.

## [Managing Locale Elements](#managing-locale-elements)
...
'분' 단위임을 명확히 나타내기 위해 'min'으로 표기합니다
...
한국어(ko\_KR)에서 날짜를 점(.)으로 축약할 때 각 점은 \[연\]·\[월\]·\[일\]을 대신하므로, 마지막 \[일\] 뒤에도 점을 반드시 찍습니다. 축약형은 `7. 16.`처럼 표기합니다. `점(.) 축약`은 ko\_KR 날짜의 표기 변형일 뿐, 전달 가능한 로케일 ID가 아닙니다. (예: 2026년 3월 31일 → 2026. 3. 31.)
...
### [Counter and Number Formats](#counter-and-number-formats)
...
### [Other Important Formats](#other-important-formats)
...
[이전 문서Inclusive Design](/foundations/inclusive-design)[다음 문서Layout](/foundations/layout)
