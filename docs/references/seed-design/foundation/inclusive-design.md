...
fetched: 2026-08-31T04:58:57.931Z
-->
...
SEED는 모든 사용자가 제품을 쉽게 접근하고 사용할 수 있도록 돕습니다.

![Inclusive Design cover image](/og/foundations/inclusive-design.webp)
...
### [Touch Area Size](#touch-area-size)
...
### [Clear Navigation Structure](#clear-navigation-structure)
...
## [Personalization and User Control](#personalization-and-user-control)
...
### [Automatic Media Playback](#automatic-media-playback)
...
[이전 문서Gradient](/foundations/gradient)[다음 문서International Design](/foundations/international-design)
