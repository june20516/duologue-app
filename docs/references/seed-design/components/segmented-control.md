...
fetched: 2026-09-21T04:26:58.389Z
-->
...
Figma[React](/react/components/segmented-control)[Lynx](/lynx/components/segmented-control)iOSAndroid

![Segmented Control cover image](/og/components/segmented-control.webp)

## [Anatomy](#anatomy)

![Segmented Control의 Anatomy 이미지. Container, Segment, Label, Badge (Optional)로 구성됩니다.](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/9c9315a6-74cb-4c98-8c55-fcfd15c115eb)
...
![Segmented Control의 Number of Controls - 2개, 3개, 4개](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e70676a9-1266-4a23-89df-01740d758310)

세그먼트화된 아이템은 2~4개의 세그먼트로 구성될 수 있습니다.

### [State](#state)

![Segmented Control의 State - Selected-Enabled, Selected-Pressed, Pressed, Disabled, Selected-Disabled](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ac448585-4d49-4f38-b115-b31d34925935)
...
![인기순, 추천순 Label을 포함하는 Segmented Control](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/67c58705-c8d4-4188-a3dd-561206fba6fb)

![가장 인기있는 리뷰, 추천이 많은 리뷰 Label을 포함하는 Segmented Control](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/9742f4c0-c40b-4238-a488-7285889650cb)
...
![3개의 선택지를 포함하는 Segmented Control](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e89fa486-b12f-432a-8280-a1118163bfa4)

![5개의 선택지를 포함하는 Segmented Control](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/989c8095-54e9-4d9d-b57a-e6ef20074fda)
...
![한 화면에 2개의 Segmented Control이 사용된 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c6e9c9e2-cde6-41fb-a5c2-246b50cdc428)
...
![지도, 거리뷰, 3D 중 지도 보기 중 전환하는 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6d1ac6e6-9e17-44a2-a988-f2bfc43a1063)
...
![동네 필터링에 활용하는 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1356ae57-8f33-4e6e-9cf3-ce1d985f6c63)
...
![선택한 항목별로 다른 내용을 표시하는 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/cc043fa4-78e1-44a5-8c3a-6a3fcb7cd4ac)
...
![Tabs를 동네생활, 모임, 단지 간 화면 전환을 위해 사용한 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d567c6f4-6cf4-482e-9be8-dcdcca6f45ba)

![Segmented Control을 동네생활, 모임, 단지 간 화면 전환을 위해 사용한 예시](https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d301ec31-dc54-447c-810b-0e6d6cad5c57)
